...
#xz:
 eval "${INSTALL_PRE}" "${INSTALL_SRC}/xz" -o "${INSTALL_DIR}/xz" && eval "${INSTALL_POST}" "${INSTALL_DIR}/xz" "${INSTALL_STRATEGY}"
 eval "${INSTALL_PRE}" "${INSTALL_SRC}/unxz" -o "${INSTALL_DIR}/unxz" && eval "${INSTALL_POST}" "${INSTALL_DIR}/unxz" "${INSTALL_STRATEGY}"
#Yq
